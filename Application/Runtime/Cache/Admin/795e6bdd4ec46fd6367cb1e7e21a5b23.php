                                                    ...
                                                    <div class="portlet">
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                                                ...
                                                                <tbody>
                                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr class="">
...
<!-- END CONTAINER -->
<script>
$(document).on('click','.y_clolor_red',function del(){
...
$(document).on('click','.contentAlert',function(){
	...
	$.post("<?php echo U('Content/platformAlert');?>",{'id':id,'state':state}, function (data) {
		layui.use('layer',function(){
			var layer = layui.layer;
			layer.open({
				  type: 1,
...
$(document).on('click','.y_clolor_yellow',function(){
	...
	var state = $(this).prev().prev().prev().val();
	$.post("<?php echo U('Content/editPlatform');?>",{'id':id,'state':state}, function (data) {
		layui.use('layer',function(){
			var layer = layui.layer;
			layer.open({
				  type: 1,
...
$(document).on('click','.y_clolor_green',function(){
	var id = $(this).prev().prev().prev().prev().prev().val();
