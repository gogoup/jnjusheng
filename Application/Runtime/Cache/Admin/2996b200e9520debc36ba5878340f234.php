                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="tabbable tabbable-custom">
                                            <ul class="nav nav-tabs y_tabTitle">
                                                ...
                                                <li><a href="person2.html">驳回审核</a></li>
                                            </ul>
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered">
                                                                ...
                                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="">
                                                                        ...
                                                                        <td class="operation" value="<?php echo ($list["user_id"]); ?>">审核</td>
    ...
    $(function(){
        $(".operation").click(function() {
            ...
            layer.confirm('审核通过该活动？', {
                ...
                $.post("edituser.html",{actid:actid},function(msg){
                    if(msg)
                    {
                        layer.msg('YES');
                ...
                $.post("edit1user.html", {actid: actid}, function (msg) {
                    if (msg) {
                        layer.msg('YES');
                        window.location.reload();
                    } else {
