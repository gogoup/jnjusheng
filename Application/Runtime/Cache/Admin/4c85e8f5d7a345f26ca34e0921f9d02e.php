                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-reorder"></i>企业入驻审核</div>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="tabbable tabbable-custom">
                                            <ul class="nav nav-tabs y_tabTitle">
                                                <li><a href="enter.html" >全部</a></li>
                                                <li class="active"><a href="#" >待审核</a></li>
                                                <li><a href="enter2.html" >驳回申请</a></li>
                                            </ul>
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered">
                                                                ...
                                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="">
                                                                        ...
                                                                        <td><span class="seecompany" value="<?php echo ($list["user_id"]); ?>">查看</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="auditcom" value="<?php echo ($list["id"]); ?>">审核</span></td>
    ...
    $(function(){
        ...
        $(".auditcom").click(function(){
            ...
            layer.confirm('审核通过企业信息？', {
                ...
                $.post('editenter.html',{id:comid},function(msg){
                    if(msg)
                    {
                        layer.msg("OK");
                ...
                $.post('editentered.html',{id:comid},function(msg){
                    if(msg)
                    {
                        layer.msg("OK");
                        window.location.reload();
