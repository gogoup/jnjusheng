                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-reorder"></i>会面预约</div>
                                <div class="tools">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="tabbable tabbable-custom">
                                            <ul class="nav nav-tabs y_tabTitle">
                                                <li><a href="metting.html">全部</a></li>
                                                <li class="active"><a href="#tab_1_2">待审核</a></li>
                                                <li><a href="metting2.html">驳回审核</a></li>
                                            </ul>
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered">
                                                                ...
                                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="">
                                                                    ...
                                                                    <td><?php echo ($list["met_time"]); ?></td>
                                                                    <td class="auditmet" value="<?php echo ($list["m_id"]); ?>">审核</td>
...
<script>
    $(function(){
        $(".auditmet").click(function(){
            var id=$(this).attr('value');
            layer.confirm('确认通过该预约？', {
                btn: ['通过','驳回'] //按钮
            }, function() {
                $.post('auditmet.html', {id: id}, function (msg) {
                    if (msg) {
                        layer.msg("OK");
                ...
                $.post('auditmeted.html', {id: id}, function (msg) {
                    if (msg) {
                        layer.msg("OK");
                        window.location.reload();
                    }
