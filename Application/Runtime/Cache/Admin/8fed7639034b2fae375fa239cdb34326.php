                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-reorder"></i>企业信息审核</div>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="tabbable tabbable-custom">
                                            <ul class="nav nav-tabs y_tabTitle">
                                                <li><a href="company.html" >全部</a></li>
                                                <li class="active"><a href="#" >待审核</a></li>
                                                <li><a href="company2.html" >驳回审核</a></li>
                                            </ul>
                                                        ...
                                                        <div class="portlet-body">
                                                            ...
                                                            <table class="table table-striped table-hover table-bordered">
                                                                ...
                                                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="">
                                                                        ...
                                                                        <td><?php echo ($list["registered_fund"]); ?></td>
                                                                        <td><?php echo ($list["work_tel"]); ?></td>
                                                                        <td><?php echo ($list["founding_time"]); ?></td>
                                                                        <td><span class="seecompany" value="<?php echo ($list["user_id"]); ?>">查看</span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="auditcom" value="<?php echo ($list["user_id"]); ?>">审核</span></td>
    ...
    $(function(){
        $(".seecompany").click(function(){
            ...
            layer.open({
                ...
                shade: 0.8,
                area: ['60%', '90%'],
                content: 'checkcom.html?id='+actid
            });
        })

        $(".auditcom").click(function(){
            var comid=$(this).attr('value');
            layer.confirm('审核通过企业信息？', {
                btn: ['通过','驳回'] //按钮
            },function(){
                $.post('edituser.html',{actid:comid},function(msg){
                    if(msg)
                    {
                        layer.msg("OK");
                ...
                $.post('edit1user.html',{actid:comid},function(msg){
                    if(msg)
                    {
                        layer.msg("OK");
                        window.location.reload();
