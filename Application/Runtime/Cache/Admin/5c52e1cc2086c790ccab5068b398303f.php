                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue tabbable">
                            <div class="portlet-title">
                                <div class="caption"><i class="icon-reorder"></i>缴费记录</div>
                            </div>
                                            ...
                                            <div class="portlet">
                                                <div class="portlet-body">
                                                    ...
                                                    <div class="span12" style="margin-left:2px">
                                                        <span id="y_span1">搜索：</span><input style="height: 25px;"  id="theval" type="text">
                                                        <button class="y_btn" id="sellog">确认</button>&nbsp;&nbsp;
                                                    </div>
                                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                                        ...
                                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="">
                                                            ...
                                                            <td><a href=""><?php echo ($list["company_id"]); ?></a></td>
                                                            <td><?php echo ($list["company"]); ?></td>
                                                            <td><?php echo ($list["getpay"]); ?></td>
...
<script>
    $(function(){
        $("#sellog").click(function(){
           var val=$('#theval').val();
            $.get("sellog.html",{theval:val},function(data){
                $("tbody").html('');
                $('tbody').append(data);
            })
        })
