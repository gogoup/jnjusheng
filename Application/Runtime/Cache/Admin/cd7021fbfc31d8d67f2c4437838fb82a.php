                    ...
                    <div class="portlet-body form">
                        ...
                        <script>
                            ...
                            function senddata()
                            {
                                ...
                                var data={title:title,company_id:company,list_img:img,description:description,content:content};
                                console.log(data);
                                $.post("<?php echo U('Business/addguidance');?>",{data:data},function(msg){
                                    if(msg)
                                    {
                                        alert("操作成功");
                                        var index = parent.layer.getFrameIndex(window.name);  parent.layer.close(index); parent.location.reload();
                                    }else{
                                        alert("操作发生错误");
                                        var index = parent.layer.getFrameIndex(window.name);  parent.layer.close(index); parent.location.reload();
                                    }
