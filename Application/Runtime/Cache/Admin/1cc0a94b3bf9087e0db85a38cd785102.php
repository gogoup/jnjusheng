                            ...
                            <div class="span12">
                                ...
                                <div class="portlet box blue tabbable">
                                    <div class="portlet-title">
                                        <div class="caption"><i class="icon-reorder"></i>项目管理</div>
                                    </div>
...
$(document).on('click','.contentAlert',function(){
	...
	$.post("<?php echo U('Content/projectAlert');?>",{'id':id}, function (data) {
		layui.use('layer',function(){
			var layer = layui.layer;
			layer.open({
				  type: 1,
...
$(document).on('click','.y_clolor_yellow',function(){
	...
	$.post("<?php echo U('Content/editProject');?>",{'id':id}, function (data) {
		layui.use('layer',function(){
			var layer = layui.layer;
			layer.open({
				  type: 1,
...
$(document).on('click','.y_clolor_green',function(){
	...
	//alert(id);
	$.post("<?php echo U('Content/tuisong');?>",{'id':id,'table':'Project'}, function (data) {
		layui.use('layer',function(){
			var layer = layui.layer;
			if(data){
				layer.alert('推送成功');
...
$(document).on('click','.y_btn',function(){
	...
	$.post("<?php echo U('Content/serchAll');?>",{'title':title,'table':'Project'}, function (data) {
		//alert(data);
