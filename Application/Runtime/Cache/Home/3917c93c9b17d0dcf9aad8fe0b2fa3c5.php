            ...
            <div class="business-con float-clear">
                <div class="business-con-left">
                    ...
                    <li style="display:none;"><a></a></li>
                        ...
                        <li>
                            <a href="<?php echo U('Business/business2');?>" class="business-con-now">创业指导</a>
                        </li>
                        <li>
                ...
                <div class="business-con-right">
                    ...
                    <div class="business-con-right-tab">
                        <div class="info-matter-right">
                            <ul>
                            	<?php if(is_array($guidance_list)): $i = 0; $__LIST__ = $guidance_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li>
                                    <a href="<?php echo U('Business/guidance?id='.$value[id]);?>" class="float-clear">
                                        <p><?php echo ($value["description"]); ?></p><span><?php echo ($value["createtime"]); ?></span>
                                    </a>
