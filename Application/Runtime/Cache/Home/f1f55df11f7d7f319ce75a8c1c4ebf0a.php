            ...
            <div class="hatcher-content float-clear">
                <div class="business-con-left">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo U('Hatcher/hatcher2');?>">政策介绍</a>
                        </li>
                        <li>
                ...
                <div class="business-con-right">
                    ...
                    <div class="business-con-right-tab">
                        <div class="hatcher-info">
                            <ul>
                               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><li>
                                    <a href="<?php echo U('Hatcher/detail?id='.$value[id]);?>" class="float-clear">
                                        <img src="<?php echo ($value["list_img"]); ?>" alt="" class="hatcher-info-img">
                                        <div class="hatcher-info-detail">
                                            <h3><?php echo ($value["title"]); ?></h3>
                                            <p class="float-clear"><img src="/Public/Home/image/hatcher-position.png" alt=""><span><?php echo ($value["address"]); ?></span></p>
                                            <p class="float-clear"><img src="/Public/Home/image/hatcher-space.png" alt=""><span><?php echo ($value["area"]); ?>m²</span></p>
                                        </div>
                                    </a>
