...
<div class="wrapper">
    ...
    <div class="content">
        <div class="common-middle">
            ...
            <div class="service-new-con float-clear">
                <div class="service-new-left">
                    <div class="service-new-left-detail">
                        <div class="service-section-header float-clear">
                            <span>创业大赛</span><a href="<?php echo U('Information/activity?state=2');?>">了解更多</a>
                        </div>
                        <img src="<?php echo ($ac[list_img]); ?>" alt="">
                    </div>
                   <!-- <img src="image/home-activity.jpg" alt="">-->
                    <div class="service-new-left-detail">
                        <div class="service-section-header float-clear">
                            <span>资讯中心</span><a href="<?php echo U('Information/information');?>">了解更多</a>
                        </div>
                        <?php if(is_array($listimg)): $i = 0; $__LIST__ = $listimg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><img src="<?php echo ($value["listimg"]); ?>" alt=""><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <div class="info-matter-right service-new-right">
                    <ul>
                        <?php if(is_array($list)): foreach($list as $key=>$val): ?><li>
                            <a href="/index.php/Home/Information/substance/state/<?php echo ($state); ?>/id/<?php echo ($val["id"]); ?>.html" class="float-clear">
