...
<head>
    ...
    <script type="text/javascript" src="/Public/Home/js/bannerList.js"></script>
    <!--[if lt IE 9]>
...
<div class="wrapper">
        ...
        <div class="header-bottom">
                <div class="header-nav common-middle">
                    <ul class="float-clear">
                        ...
                        <li><a href="#"><span>资讯服务</span></a>
                            <div class="header-nav-slide float-clear">
                                <div class="header-nav-slide-left">
                                    <img src="/Public/Home/image/nav-slide1.jpg" alt="">
                                </div>
                        ...
                        <li><a href="#"><span>服务导航</span></a>
                            <div class="header-nav-slide float-clear">
                                <div class="header-nav-slide-left">
                                    <img src="/Public/Home/image/nav-slide2.jpg" alt="">
                                </div>
                        ...
                        <li><a href="#"><span>创业导师</span></a>
                            <div class="header-nav-slide float-clear">
                                <div class="header-nav-slide-left">
                                    <img src="/Public/Home/image/nav-slide3.jpg" alt="">
                                </div>
                                <div class="header-nav-slide-right">
                                    <a href="#">创业课程</a>
                                    <a href="#">专题讲座</a>
    ...
    <div class="banner">
        <ul class="float-clear">
            <li><a href=""><img src="/Public/Home/image/home-banner1.png" alt=""></a></li>
            <li><a href=""><img src="/Public/Home/image/home-banner2.png" alt=""></a></li>
            <li><a href=""><img src="/Public/Home/image/home-banner3.jpg" alt=""></a></li>
            <li><a href=""><img src="/Public/Home/image/home-banner4.png" alt=""></a></li>
        </ul>
    ...
    <!--创业指导-->
    <div class="home-guide common-middle">
        <ul class="float-clear">
            <li>
            <div class="guide-list float-clear">
                <em>1</em><span>提出申请</span><i></i>
            </div>
            </li>
            <li>
                <div class="guide-list float-clear">
                    <em>2</em><span>申请受理</span><i></i>
                </div>
            </li>
            <li>
                <div class="guide-list float-clear">
                    <em>3</em><span>项目评审</span><i></i>
                </div>
            </li>
            <li>
                <div class="guide-list float-clear">
                    <em>4</em><span>签署协议</span><i></i>
                </div>
            </li>
            <li>
                <div class="guide-list float-clear">
                    <em>5</em><span>正式入住</span><i></i>
                </div>
            </li>
            <li>
                <div class="guide-list float-clear">
                    <em>6</em><span>启动创业</span>
                </div>
            </li>
        </ul>
    </div>
        ...
        <div class="home-info-content float-clear">
            <div class="home-info-list">
                <ul>
                    ...
                    <li><span>创业政策</span></li>
                    <li><span>产业资讯</span></li>
            ...
            <div class="home-info-detail">
                <ul>
                    <li>
                        <div class="home-info-matter float-clear">
                            <div class="info-matter-left">
                                <img src="/Public/Home/image/jz1.jpg" alt="">
                    ...
                    <li>
                        <div class="home-info-matter float-clear">
                            <div class="info-matter-left">
                                <img src="/Public/Home/image/jz2.jpg" alt="">
                                <div class="info-matter-left-bot">
                                    <h4>奎文区歌德创业园举办金秋大型人才招聘会</h4>
                                    <p>9月23日上午，奎文区歌德创业园在万达广场举办歌德·智联2017金秋大型人才招聘会。本次招聘会由奎文区人社局主办，歌德创业园、奎文区工商联、北苑街办、东关街办、智联招聘、万达集团共同承办。</p>
                                </div>
                    ...
                    <li>
                        <div class="home-info-matter float-clear">
                            <div class="info-matter-left">
                                <img src="/Public/Home/image/jz3.jpg" alt="">
                                <div class="info-matter-left-bot">
                                    <h4>奎文区歌德创业园举办金秋大型人才招聘会</h4>
                                    <p>9月23日上午，奎文区歌德创业园在万达广场举办歌德·智联2017金秋大型人才招聘会。本次招聘会由奎文区人社局主办，歌德创业园、奎文区工商联、北苑街办、东关街办、智联招聘、万达集团共同承办。</p>
                                </div>
                    ...
                    <li>
                        <div class="home-info-matter float-clear">
                            <div class="info-matter-left">
                                <img src="/Public/Home/image/jz4.jpg" alt="">
                                <div class="info-matter-left-bot">
                                    <h4>奎文区歌德创业园举办金秋大型人才招聘会</h4>
                                    <p>9月23日上午，奎文区歌德创业园在万达广场举办歌德·智联2017金秋大型人才招聘会。本次招聘会由奎文区人社局主办，歌德创业园、奎文区工商联、北苑街办、东关街办、智联招聘、万达集团共同承办。</p>
                                </div>
        ...
        <div class="home-project-content">
            <ul class="float-clear">
                    ...
                    <div class="home-project-detail">
                        <div class="home-project-detail-top float-clear">
                            <div class="home-project-detail-img">
                                <img src="/Public/Home/image/projectLogo1.png" alt="">
                            </div>
                ...
                <div class="home-project-detail">
                    <div class="home-project-detail-top float-clear">
                        <div class="home-project-detail-img">
                            <img src="/Public/Home/image/projectLogo2.png" alt="">
                        </div>
                        <div class="home-project-detail-top-detail">
                            <h4>新型空气净化器</h4>
                            <span>联系人：</span><span>XXX</span>
                ...
                <li>
                    <div class="home-project-detail">
                        <div class="home-project-detail-top float-clear">
                            <div class="home-project-detail-img">
                                <img src="/Public/Home/image/projectLogo3.png" alt="">
                            </div>
                            <div class="home-project-detail-top-detail">
                                <h4>手工皂生产项目</h4>
                                <span>联系人：</span><span>XXX</span>
                ...
                <li>
                    <div class="home-project-detail">
                        <div class="home-project-detail-top float-clear">
                            <div class="home-project-detail-img">
                                <img src="/Public/Home/image/projectLogo4.png" alt="">
                            </div>
                            <div class="home-project-detail-top-detail">
                                <h4>乡村旅游项目招商</h4>
                                <span>联系人：</span><span>XXX</span>
