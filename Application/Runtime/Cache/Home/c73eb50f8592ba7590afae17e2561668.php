                ...
                <div class="service-content float-clear">
                    <div class="service-con-left">
                        ...
                        <div class="home-info-list service-con-left-list" id="service-new-left">
                            <ul class="float-clear">
                                <li><a href="<?php echo U('Information/news?state=1');?>">通知公告</a></li>
                                <li><a href="<?php echo U('Information/news?state=2');?>">企业新闻</a></li>
                                <li><a href="<?php echo U('Information/news?state=3');?>">申报快讯</a></li>
                                <li><a href="<?php echo U('Information/news?state=4');?>">媒体报道</a></li>
                            </ul>
                        </div>
                    </div>
