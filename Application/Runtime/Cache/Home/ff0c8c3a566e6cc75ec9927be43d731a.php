...
<div class="wrapper">
    ...
    <div class="hatcher" style="padding-bottom:20px;">
        <div class="common-middle">
            <!--孵化空间简述-->
            <div class="hatcher-detail">
                <div class="common-section-header float-clear">
                    <span>基本信息</span>
                </div>
                <div class="hatcher-detail-sum float-clear">
                    <img src="/Public/Home/image/hatcher2.jpg" alt="" class="hatcher-info-img">
                    <div class="hatcher-info-detail">
                        <h3><?php echo ($content["title"]); ?></h3>
                        <p class="float-clear"><img src="/Public/Home/image/hatcher-position.png" alt=""><span><?php echo ($content["address"]); ?></span></p>
                        <p class="float-clear"><img src="/Public/Home/image/hatcher-space.png" alt=""><span><?php echo ($content["area"]); ?>m²</span></p>
                        <?php if($_SESSION['uid'] != '' OR $_SESSION['urole']== 2 ): ?><button id="meet-show">申请入孵</button><?php endif; ?>     
                    </div>
                </div>
            </div>
            <!--空间介绍-->
            ...
            <div class="hatcher-detail">
                ...
                <div class="hatcher-detail-enter">
                    <p>
                        <?php echo ($content["condition"]); ?>
                    </p>
            ...
            <div class="hatcher-detail">
                ...
                <div class="hatcher-detail-position float-clear">
                    <img src="/Public/Home/image/hatcher-map.png" alt="" class="hatcher-info-img">
                    <div class="hatcher-info-detail">
                        <p class="float-clear"><span>详细地址：</span><span><?php echo ($content["address"]); ?></span></p>
                        <p class="float-clear"><span>联系人：</span><span><?php echo ($content["people"]); ?></span></p>
                        <p class="float-clear"><span>联系方式：</span><span><?php echo ($content["tel"]); ?></span></p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
	$('#meet-show').click(function(){
		layer.confirm('您确定要入住此孵化器吗？？？',function(){
			$.ajax({
				'url':"<?php echo U('Hatcher/incubation');?>",
				'type':'post',
				'dataType':'text',
				'success':function(msg){
					if(msg>1){
						layer.alert('申请失败，请联系相关负责人!');
					}else{
						layer.alert('申请成功，请耐心等待审核!');
					}
				}
			});
		});
